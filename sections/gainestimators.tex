...
\textcolor{blue}{FINISH: The original Chao estimator utilizes the Finally, Hwang et al.~\cite{hwang:2010} propose estimator for $f_0$ that is more robust in the presence of little information has been proposed by Hwang et al.~\cite{hwang:2010}.}
