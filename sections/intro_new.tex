...
\agp{I don't think we need to define crowdsourcing, waste of space; if
you fix example in abstract, I'd fix this as well..}
...
However, while the previous work has demonstrated that it is indeed possible
...
For example, the \agp{fix based on example: popular entity X will be provided several times, while Y will only rarely be provided}.
