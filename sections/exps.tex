...
\vspace{3pt}\noindent{\ul{\textbf{How does our querying policy algorithm compare against baselines?}}}
...
\vspace{3pt}\noindent{\ul{\textbf{How do our techniques compare against a near-optimal policy discovery algorithm?}}}
...
\vspace{3pt}\noindent{\ul{\textbf{How do the different techniques compare with respect to the total number of queries issued during extraction?}}}
...
\vspace{3pt}\noindent{\ul{\textbf{How our different algorithms traverse the poset and use different query configurations?}}}
...
\vspace{3pt}\noindent{\ul{\textbf{How effective are the different estimators at predicting the gain of additional queries?}}}
