...
\begin{figure}[h]
\begin{center}
        \subfigure{\includegraphics[clip,scale=0.32]{figs/ebExtractionNotOpt.eps} \label{fig:ebextraction}}
        \subfigure{\includegraphics[clip,scale=0.32]{figs/poExtractionNotOpt.eps} \label{fig:poextraction}}
\end{center}
\vspace{-10pt}
...
\begin{figure}[h]
\begin{center}
        \subfigure{\includegraphics[clip,scale=0.32]{figs/ebExtractionOpt.eps} \label{fig:ebextractionopt}}
        \subfigure{\includegraphics[clip,scale=0.32]{figs/poExtractionOpt.eps} \label{fig:poextractionopt}}
\end{center}
\vspace{-10pt}
