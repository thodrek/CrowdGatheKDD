...
%\begin{figure}[h]
%\begin{center}
%        \subfigure{\includegraphics[clip,scale=0.32]{figs/ebExtractionAll.eps} \label{fig:ebextraction}}
%        \subfigure{\includegraphics[clip,scale=0.32]{figs/poExtraction.eps} \label{fig:poextraction}}
%\end{center}
%\vspace{-10pt}
%\caption{The number of entities extracted by different algorithms for (a) the Eventbrite data domain and (b) for the People's domain under different budgets. }
...
\begin{figure}[h]
	\begin{center}
	\subfigure{\includegraphics[clip,scale=0.32]{figs/gain_cost.eps}\label{fig:payasyougo}}
	\subfigure{\includegraphics[clip,scale=0.32]{figs/gain_rounds.eps}\label{fig:rounds}}
