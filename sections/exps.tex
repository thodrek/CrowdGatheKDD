...
\begin{figure}
\begin{center}
        \subfigure{\includegraphics[trim=120 0 0 0,scale=0.45]{figs/ebExtractionNotOpt.eps} \label{fig:ebextraction}}
        \subfigure{\includegraphics[trim=80 0 100 0,scale=0.45]{figs/poExtractionNotOpt.eps} \label{fig:poextraction}}
        \subfigure{\includegraphics[scale=0.6]{figs/notoptlegend.pdf}}
\end{center}
