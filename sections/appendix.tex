...
\label{sec:prth2}
To derive the new estimator we use of the generalized jackknife procedure~\cite{heltshe1983estimating}. Given two (biased) estimators of $S$, say $\hat{S}_1$ and $\hat{S}_2$, let $R$ be the ratio of their biases:
\begin{equation}
\small
