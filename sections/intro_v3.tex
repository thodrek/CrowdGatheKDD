...
\noindent {\em Our approach.} To limit the number of duplicate extractions we levere two insights that allow us to issue {\em fine-grained queries}, i.e., queries that target only a subspace of the overall entity-domain of interest, to the crowd:
